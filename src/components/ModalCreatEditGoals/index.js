...
const ModalCreatEditGoals = () => {

    const [showModalGoals, setShowModalGoals] = useState(false)

    const handleShowModalGoals = () => setShowModalGoals(!showModalGoals)
        ...
        <>
            ...
            <Content>
                ...
                <Container width={"440px"} height={"700px"}>
                    ...
                    <Card width={"295px"} height={"75px"}>
                        <Input placeholder="Dificuldade" width={"100%"} height={"100%"} />
                    </Card>
...
export default ModalCreatEditGoals
