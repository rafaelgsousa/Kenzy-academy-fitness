      ...
      <HomeCss>
        <header>
          ...
          <div className="nav">
            <div className="training">
              <p>
                #Training <br /> &nbsp; &nbsp; &nbsp; &nbsp; &nbsp; Like a Dev
              </p>
            </div>
            {token && (
              <nav onClick={logout} className="signup">
                Logout
              </nav>
            )}
            {!token && (
              <nav onClick={() => history.push("/login")} className="login">
                Login
              </nav>
            )}
            {!token && (
              <nav onClick={() => history.push("/signUp")} className="signup">
                Sign Up
              </nav>
            )}
          </div>
        ...
        <footer>
          <div className="infoFooter">
            <p>
              R. Gen. Mário Tourinho, 1733 <br /> Curitiba - PR, 80740-000
            </p>
            <p>
              Segunda à Sexta <br /> 7:30 às 20:30
            </p>
            <p>
              Contato <br /> (41)99745-3268
            </p>
          </div>
